...
#     indirect=True,
# )
# def test_single_stream_failed(mock_requests: None, mock_kafka: None,
...
#     indirect=True,
# )
# def test_single_stream_skipped_due_to_agentless(mock_kafka: None,
#                                                 mock_gitlab_token: None) -> None:
#     Timer(0.01, terminate_consumer).start()
#
...
#         (
#             "mock_run_message",
#             {"agent": True, "type": "GITLAB", "ref": "main",
#              "groupName": "group", "projectName": None},
#             settings.KAFKA_RUNS_TOPIC,
#         ),
#     ],
#     indirect=True,
